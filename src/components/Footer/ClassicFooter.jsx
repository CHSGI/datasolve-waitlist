  ...
  return (
    <FooterStyle>
      <Container medium>
        <FooterInfo>
          <p>
          No matter how big or how small your IT problem – or whether you’re international or local – Data Solve will take on the challenge.
          </p>
          <LogoWrapper>
            <Logo />
          </LogoWrapper>
      ...
      <>
        <Hr />
        <CopyRightContainer>
          <CopyRightText>Copyright © 2022 Datasolve</CopyRightText>
